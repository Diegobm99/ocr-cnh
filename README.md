...
<b>Possíveis melhoras:</b> Como há uma inconsistência com o uso da OCR, uma opção seria treinar um modelo próprio para extração específica dos campos da CNH.
